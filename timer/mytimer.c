...
{
	return cpustat[CPUTIME_USER] + cpustat[CPUTIME_NICE] + cpustat[CPUTIME_SYSTEM] + cpustat[CPUTIME_IDLE] + cpustat[CPUTIME_IOWAIT] + cpustat[CPUTIME_IRQ] + cpustat[CPUTIME_SOFTIRQ] + cpustat[CPUTIME_STEAL] + cpustat[CPUTIME_GUEST] + cpustat[CPUTIME_GUEST_NICE];
}
...
static void cpu_load_setup(void)
{
	...
	for_each_possible_cpu(i) {
		...
		last_usn_load += cpustat[CPUTIME_USER] + cpustat[CPUTIME_NICE] + cpustat[CPUTIME_SYSTEM];
